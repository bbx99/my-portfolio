    ...
    <section id="projects" className="py-20 px-4 max-w-7xl mx-auto">
      ...
      >
        ...
        <div className="flex-1 p-8 md:p-16 flex flex-col justify-center">
          ...
          <p className="text-gray-600 text-lg mb-10 max-w-md">ANAM CARA is a jade brand I co-created with friends. Through this project, I’ve been involved in brand presentation, website building, product storytelling, and digital content, which has helped me better understand how a creative brand connects with its audience online.</p>
